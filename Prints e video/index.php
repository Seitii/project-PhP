    ...
    <header class="bg-dark">
        ...
        <nav class="navbar navbar-expand lg navbar-dark bg-dark" >
            <a class="navbar-brand" href"#">
                <img src="  pages/clientes/fotos-clientes/logo.png" alt="Logo" width="120" height="50" class="d-inline-block align-top">
            </a>
            ...
            <div class="collpase navbar-collapse" id="conteudo-navbar">
                <ul class="navbar-nav mr-uto">
                    ...
                    <li class="nav-item "><a class="nav-link" href="index.php?menuop=clientes">Contato</a></li>
                </ul>
            </div>
        </nav>
        </div>
